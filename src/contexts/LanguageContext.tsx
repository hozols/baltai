...
const translations = {
  ...
  en: {
    ...
    'services.development.title': 'Website & App Development',
    'services.development.subtitle': 'Modern web solutions and MVP development',
    'services.development.description': 'We create professional websites, web applications and MVP solutions that help your business grow and thrive in the digital environment.',
