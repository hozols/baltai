                ...
                <CardContent className="p-0 space-y-6 flex-1">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        <a href="tel:+37120000000" className="hover:text-primary transition-colors">
                          +371 20 000 000
                        </a>
                      </p>
                      <p className="text-muted-foreground">
                        <a href="tel:+37120000001" className="hover:text-primary transition-colors">
                          +371 20 000 001
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        <a href="mailto:support@baltai.lv" className="hover:text-primary transition-colors">
                          support@baltai.lv
                        </a>
                      </p>
                    </div>
